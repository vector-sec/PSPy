...
function Get-ParameterDictionary
{
    ...
    try
    {
        Set-Content function:${directorySeparatorChar}$guid $ScriptBlock
    ...
    {
        if (Test-Path function:${directorySeparatorChar}$guid) { Remove-Item function:${directorySeparatorChar}$guid }
    }
}
