...
Describe "New-Fixture" {
    ...
    Context "Only Name parameter is specified:" {
        It "Creates fixture in current directory:" {
            $name = "Test-Fixture"
            $path = "TestDrive:${directorySeparatorChar}"
    ...
    Context "Name and Path parameter is specified:" {
        ...
        It "Creates fixture in full Path:" {
            $name = "Test-Fixture"
            $path = "TestDrive:${directorySeparatorChar}full"
        ...
        It "Creates fixture in relative Path:" {
            ...
            Join-Path -Path "$path${directorySeparatorChar}relative" -ChildPath "$name.ps1" | Should Exist
            Join-Path -Path "$path${directorySeparatorChar}relative" -ChildPath "$name.Tests.ps1" | Should Exist
        }
